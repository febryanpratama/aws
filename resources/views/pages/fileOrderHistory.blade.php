            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <p class="mb-0">It's a feature of your order files transaction in Alatan Indonesia.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-xl-4">
                <div class="card trnasiction-card">
                    ...
                    <div class="border-bottom">
                        ...
                        <div class="px-3 pb-2">
                            <form action="{{ route('fileOrderComment', [$document['fileorderdocument_id']]) }}" method="post" class="d-flex flex-row justify-content-between">
                                @csrf
                                <div class="input-group mb-3">
                                    <!-- <input type="text" placeholder="*If you want to give a comment" class="form-control" name="comments" value="{{ $document['comments'] }}"> -->
                                    <textarea name="comments" rows="2" placeholder="*If you want to give a comment" class="form-control">{{ $document['comments'] }}</textarea>
